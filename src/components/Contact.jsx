...
const Contact = ({ refProp }) => {
  return (
    <div
      ref={refProp}
      className="h-screen flex flex-col items-center justify-center dark:bg-black pt-12"
    >
          ...
          <form className="space-y-4">
            <div className="relative">
              ...
              <input
                type="text"
                placeholder="Name"
                className="w-full pl-10 p-3 rounded-md bg-blue-100 dark:bg-gray-800 focus:ring-2 focus:ring-blue-500 outline-none"
              />
            </div>
